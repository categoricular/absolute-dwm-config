...
static const unsigned int barpadding = 8; /* vertical inside the bar */
static const unsigned int snap = 32;      /* snap pixel */
static const int showbar = 1;             /* 0 means no bar */
static const int topbar = 1;              /* 0 means bottom bar */
static const char *fonts[] = {"BmapNF:size=11:antialias=true:autohint=true"};
static const char dmenufont[] = "BmapNF:size=11";
...
/* tagging */
static const char *tags[] = {"", "", "󰅩", "󰙯", "󰝚", "󱔗"};
...
static const Layout layouts[] = {
    ...
    {"󰕰 Tiling", tile}, /* First entry is default */
    {"󰈈 Float", NULL},  /* No layout function means floating behavior */
    {"󰝣 Monocle", monocle},
};
...
static const char *dmenucmd[] = {
    "dmenu_run", "-m",     dmenumon, "-fn",    dmenufont, "-nb",    cpp_base,
    "-nf",       cpp_text, "-sb",    cpp_base, "-sf",     cpp_pink, NULL};
static const char *termcmd[] = {"alacritty", NULL};

static const Key keys[] = {
    /* fullgaps binds (alt + control) */
